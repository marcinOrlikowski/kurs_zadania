...
public final class Money implements Comparable<Money> {
    ...
    private static void validateFormat(String amount) {
        if (!amount.matches(MONEY_FORMAT)) {
            throw new IllegalArgumentException("Money value must be positive and in '123.45' format");
        }
    }

    private static void validateIfNotNull(String amount) {
        if (amount == null) {
            throw new IllegalArgumentException("Cannot provide null");
        }
    }

    private static void validateDivider(double m) {
        if (m == 0) {
            throw new IllegalArgumentException("Cannot divide by 0");
        }
    }

    private static void validateMultiply(BigDecimal m) {
        if (m == null) {
            throw new IllegalArgumentException("Cannot multiply by null");
        }
    }

    private void validateSubtract(Money other) {
        if (other == null) {
    ...
    private static void validateAdd(Money other) {
        if (other == null) {
